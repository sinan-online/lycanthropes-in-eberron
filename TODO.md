...
| Dravago   | 0                                                                                   | 0     | 5+               | Placeholder. Ideas: wolf command, dire wolf summoning.                    |
...
| Barrakas  | Eternal Dawn                                                                        | 1     | 4+               | Needs 4+ more (e.g., darkvision, scent-based tracking).                   |
| Rhaan     | 0                                                                                   | 0     | 5+               | Placeholder. Ideas: song/magic (e.g., bard-like abilities).               |
| Sypheros  | 0                                                                                   | 0     | 5+               | Placeholder. Ideas: shadow manipulation, fear effects.                    |
| Aryth     | 0                                                                                   | 3     | 2+               | Placeholder. Ideas: speed boosts, death-themed abilities.                 |
| Vult      | Pack Tactics (all forms)                                                            | 1     | 4+               | Needs 4+ more (e.g., silver resistance, bonus attacks).                   |
